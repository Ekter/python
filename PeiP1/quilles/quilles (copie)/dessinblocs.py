...
def afficherétagere():
    ...
    taille3=-300*taille2/3.1*tailleetagere/1.2
    etagere(tailleetagere,taille3,-50,taille2,1,1,5,15,1.02)
    #etagere(0.0001,4351354163451,35413543521)
    for i in range(3):
        for k in range(15):
            listequilles[k%len(listequilles)](1.2*window_width()/1366,((k*4.8+18)/100-0.5)*window_width(),((10*i+46)/100-0.5)*window_height())
...
tailleinitialex=0
tailleinitialey=0
listequilles=[lit,halteres,caleçon,voiture,tomate]
tracer(0)
