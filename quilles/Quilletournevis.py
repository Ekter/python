...
def tournevis (ecran,taille,x,y,angle=0):
    tournevis = Shape("compound")
    ...
    for i in range(2):
        ...
        tortuetournevis.right(90)
    tortuetournevis.end_poly()
    tournevis.addcomponent(tortuetournevis.get_poly(),tortuetournevis.fillcolor(),tortuetournevis.pencolor())
    tortuetournevis.up()
    tortuetournevis.forward(t*16)
    tortuetournevis.right(90)
    tortuetournevis.forward(t*9)
    ...
    ecran.addshape('tournevis', shape=tournevis)
