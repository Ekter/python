...
def cafe(ecran,taille,x,y,angle=0):
    cafe = Shape("compound")
    ...
    tortuecafe.end_poly()
    cafe.addcomponent(tortuecafe.get_poly(),tortuecafe.fillcolor(),tortuecafe.pencolor())
    ...
    ecran.addshape('cafe', shape=cafe)
