from setup import *
def pate(ecran,taille,x,y,angle=0):
    x+=5*taille
    pate = Shape("compound")
    ...
    tortuepate.end_poly()
    pate.addcomponent(tortuepate.get_poly(),tortuepate.fillcolor(),tortuepate.pencolor())
    ...
    ecran.addshape('pate', shape=pate)
